...
- DyNCA: Real-Time Dynamic Texture Synthesis Using Neural Cellular Automata [[paper](https://openaccess.thecvf.com/content/CVPR2023/html/Pajouheshgar_DyNCA_Real-Time_Dynamic_Texture_Synthesis_Using_Neural_Cellular_Automata_CVPR_2023_paper.html)] [[arxiv](https://arxiv.org/abs/2211.11417)] [[paper with code](https://paperswithcode.com/paper/dynca-real-time-dynamic-texture-synthesis)]
...
- Visionary Security: Using Uncertain Real-Time Information in Signaling Games [[paper](https://www.ijcai.org/proceedings/2019/902)]
...
- Structured Siamese Network for Real-Time Visual Tracking [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Yunhua_Zhang_Structured_Siamese_Network_ECCV_2018_paper.php)] [[paper with code](https://paperswithcode.com/paper/structured-siamese-network-for-real-time)]

- ICNet for Real-Time Semantic Segmentation on High-Resolution Images [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Hengshuang_Zhao_ICNet_for_Real-Time_ECCV_2018_paper.php)] [[arxiv](https://arxiv.org/abs/1704.08545)] [[paper with code](https://paperswithcode.com/paper/icnet-for-real-time-semantic-segmentation-on)] [[code](https://github.com/hszhao/ICNet)]

- Real-Time Hair Rendering using Sequential Adversarial Networks [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Lingyu_Wei_Real-Time_Hair_Rendering_ECCV_2018_paper.php)] [[paper with code](https://paperswithcode.com/paper/real-time-hair-rendering-using-sequential)]

- HybridFusion: Real-Time Performance Capture Using a Single Depth Sensor and Sparse IMUs [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Zerong_Zheng_HybridFusion_Real-Time_Performance_ECCV_2018_paper.php)] [[paper with code](https://paperswithcode.com/paper/hybridfusion-real-time-performance-capture)]

- ArticulatedFusion: Real-time Reconstruction of Motion, Geometry and Segmentation Using a Single Depth Camera [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Chao_Li_ArticulatedFusion_Real-time_Reconstruction_ECCV_2018_paper.php)] [[arxiv](https://arxiv.org/abs/1807.07243)] [[paper with code](https://paperswithcode.com/paper/articulatedfusion-real-time-reconstruction-of)]
...
- GraspNet: An Efficient Convolutional Neural Network for Real-time Grasp Detection for Low-powered Devices [[paper](https://www.ijcai.org/proceedings/2018/677)]

- Near Real-Time Detection of Poachers from Drones in AirSim [[paper](https://www.ijcai.org/proceedings/2018/847)]


## AAAI-2018


- Asymmetric Action Abstractions for Multi-Unit Control in Adversarial Real-Time Games [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/11432)] [[arxiv](https://arxiv.org/abs/1711.08101)] [[paper with code](https://paperswithcode.com/paper/asymmetric-action-abstractions-for-multi-unit)]

- Avoiding Dead Ends in Real-Time Heuristic Search [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/11533)]
...
- T-C3D: Temporal Convolutional 3D Network for Real-Time Action Recognition [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/12333)]

- Expressive Real-Time Intersection Scheduling [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/12073)]