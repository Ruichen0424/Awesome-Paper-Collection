...
- Invisible Backdoor Attack against 3D Point Cloud Classifier in Graph Spectral Domain [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/30099)]
...
- MarS3D: A Plug-and-Play Motion-Aware Model for Semantic Segmentation on Multi-Scan 3D Point Clouds [[paper](https://openaccess.thecvf.com/content/CVPR2023/html/Liu_MarS3D_A_Plug-and-Play_Motion-Aware_Model_for_Semantic_Segmentation_on_Multi-Scan_CVPR_2023_paper.html)] [[arxiv](https://arxiv.org/abs/2307.09316)] [[paper with code](https://paperswithcode.com/paper/mars3d-a-plug-and-play-motion-aware-model-for-1)] [[code](https://github.com/cvmi-lab/mars3d)]
...
- DUP-Net: Denoiser and Upsampler Network for 3D Adversarial Point Clouds Defense [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Zhou_DUP-Net_Denoiser_and_Upsampler_Network_for_3D_Adversarial_Point_Clouds_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1812.11017)] [[paper with code](https://paperswithcode.com/paper/deflecting-3d-adversarial-point-clouds)] [[code](https://github.com/RyanHangZhou/DUP-Net)]

- LPD-Net: 3D Point Cloud Learning for Large-Scale Place Recognition and Environment Analysis [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Liu_LPD-Net_3D_Point_Cloud_Learning_for_Large-Scale_Place_Recognition_and_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1812.07050)] [[paper with code](https://paperswithcode.com/paper/181207050)] [[code](https://github.com/Suoivy/LPD-net)]

- 3D Point Cloud Generative Adversarial Network Based on Tree Structured Graph Convolutions [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Shu_3D_Point_Cloud_Generative_Adversarial_Network_Based_on_Tree_Structured_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1905.06292)] [[paper with code](https://paperswithcode.com/paper/3d-point-cloud-generative-adversarial-network)] [[code](https://github.com/jtpils/treegan)]
...
- Skeleton-Aware 3D Human Shape Reconstruction From Point Clouds [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Jiang_Skeleton-Aware_3D_Human_Shape_Reconstruction_From_Point_Clouds_ICCV_2019_paper.html)] [[paper with code](https://paperswithcode.com/paper/skeleton-aware-3d-human-shape-reconstruction)]

- GraphX-Convolution for Point Cloud Deformation in 2D-to-3D Conversion [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Nguyen_GraphX-Convolution_for_Point_Cloud_Deformation_in_2D-to-3D_Conversion_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1911.06600)] [[paper with code](https://paperswithcode.com/paper/graphx-convolution-for-point-cloud-1)] [[code](https://github.com/justanhduc/graphx-conv)]

- MeteorNet: Deep Learning on Dynamic 3D Point Cloud Sequences [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Liu_MeteorNet_Deep_Learning_on_Dynamic_3D_Point_Cloud_Sequences_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1910.09165)] [[paper with code](https://paperswithcode.com/paper/meteornet-deep-learning-on-dynamic-3d-point)] [[code](https://github.com/xingyul/meteornet)]
...
- Multi-Angle Point Cloud-VAE: Unsupervised Feature Learning for 3D Point Clouds From Multiple Angles by Joint Self-Reconstruction and Half-to-Half Prediction [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Han_Multi-Angle_Point_Cloud-VAE_Unsupervised_Feature_Learning_for_3D_Point_Clouds_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1907.12704)] [[paper with code](https://paperswithcode.com/paper/multi-angle-point-cloud-vae-unsupervised)]


## AAAI-2019


- Point2Sequence: Learning the Shape Representation of 3D Point Clouds with an Attention-Based Sequence to Sequence Network [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/4903)] [[arxiv](https://arxiv.org/abs/1811.02565)] [[paper with code](https://paperswithcode.com/paper/point2sequence-learning-the-shape)]

- CAPNet: Continuous Approximation Projection for 3D Point Cloud Reconstruction Using 2D Supervision [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/4908)] [[arxiv](https://arxiv.org/abs/1811.11731)] [[paper with code](https://paperswithcode.com/paper/capnet-continuous-approximation-projection)] [[code](https://github.com/val-iisc/capnet)]
...
- SGPN: Similarity Group Proposal Network for 3D Point Cloud Instance Segmentation [[paper](https://openaccess.thecvf.com/content_cvpr_2018/html/Wang_SGPN_Similarity_Group_CVPR_2018_paper.html)] [[arxiv](https://arxiv.org/abs/1711.08588)] [[paper with code](https://paperswithcode.com/paper/sgpn-similarity-group-proposal-network-for-3d)] [[code](https://github.com/laughtervv/SGPN)]

- Recurrent Slice Networks for 3D Segmentation of Point Clouds [[paper](https://openaccess.thecvf.com/content_cvpr_2018/html/Huang_Recurrent_Slice_Networks_CVPR_2018_paper.html)] [[arxiv](https://arxiv.org/abs/1802.04402)] [[paper with code](https://paperswithcode.com/paper/recurrent-slice-networks-for-3d-segmentation)] [[code](https://github.com/qianguih/RSNet)]
...
- Reflection Removal for Large-Scale 3D Point Clouds [[paper](https://openaccess.thecvf.com/content_cvpr_2018/html/Yun_Reflection_Removal_for_CVPR_2018_paper.html)] [[paper with code](https://paperswithcode.com/paper/reflection-removal-for-large-scale-3d-point)]
...
- 3D Recurrent Neural Networks with Context Fusion for Point Cloud Semantic Segmentation [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Xiaoqing_Ye_3D_Recurrent_Neural_ECCV_2018_paper.php)] [[paper with code](https://paperswithcode.com/paper/3d-recurrent-neural-networks-with-context)]

- Multiresolution Tree Networks for 3D Point Cloud Processing [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Matheus_Gadelha_Multiresolution_Tree_Networks_ECCV_2018_paper.php)] [[arxiv](https://arxiv.org/abs/1807.03520)] [[paper with code](https://paperswithcode.com/paper/multiresolution-tree-networks-for-3d-point)] [[code](https://github.com/matheusgadelha/MRTNet)]

- 3DFeat-Net: Weakly Supervised Local 3D Features for Point Cloud Registration [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Zi_Jian_Yew_3DFeat-Net_Weakly_Supervised_ECCV_2018_paper.php)] [[arxiv](https://arxiv.org/abs/1807.09413)] [[paper with code](https://paperswithcode.com/paper/3dfeat-net-weakly-supervised-local-3d)] [[code](https://github.com/yewzijian/3DFeatNet)]


## ICML-2018


- Learning Representations and Generative Models for 3D Point Clouds [[paper](https://proceedings.mlr.press/v80/achlioptas18a.html)] [[arxiv](https://arxiv.org/abs/1707.02392)] [[paper with code](https://paperswithcode.com/paper/learning-representations-and-generative)] [[code](https://github.com/optas/latent_3d_points)]
