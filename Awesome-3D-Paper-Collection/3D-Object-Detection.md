...
- Delving Into Localization Errors for Monocular 3D Object Detection [[paper](https://openaccess.thecvf.com/content/CVPR2021/html/Ma_Delving_Into_Localization_Errors_for_Monocular_3D_Object_Detection_CVPR_2021_paper.html)] [[arxiv](https://arxiv.org/abs/2103.16237)] [[paper with code](https://paperswithcode.com/paper/delving-into-localization-errors-for)] [[code](https://github.com/xinzhuma/monodle)]
...
- The Devil Is in the Task: Exploiting Reciprocal Appearance-Localization Features for Monocular 3D Object Detection [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Zou_The_Devil_Is_in_the_Task_Exploiting_Reciprocal_Appearance-Localization_Features_ICCV_2021_paper.html)] [[arxiv](https://arxiv.org/abs/2112.14023)] [[paper with code](https://paperswithcode.com/paper/the-devil-is-in-the-task-exploiting-1)]

- Gated3D: Monocular 3D Object Detection From Temporal Illumination Cues [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Julca-Aguilar_Gated3D_Monocular_3D_Object_Detection_From_Temporal_Illumination_Cues_ICCV_2021_paper.html)] [[arxiv](https://arxiv.org/abs/2102.03602)] [[paper with code](https://paperswithcode.com/paper/gated3d-monocular-3d-object-detection-from)]

- Are We Missing Confidence in Pseudo-LiDAR Methods for Monocular 3D Object Detection? [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Simonelli_Are_We_Missing_Confidence_in_Pseudo-LiDAR_Methods_for_Monocular_3D_ICCV_2021_paper.html)] [[paper with code](https://paperswithcode.com/paper/demystifying-pseudo-lidar-for-monocular-3d)]
...
- RandomRooms: Unsupervised Pre-Training From Synthetic Shapes and Randomized Layouts for 3D Object Detection [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Rao_RandomRooms_Unsupervised_Pre-Training_From_Synthetic_Shapes_and_Randomized_Layouts_for_ICCV_2021_paper.html)] [[arxiv](https://arxiv.org/abs/2108.07794)] [[paper with code](https://paperswithcode.com/paper/randomrooms-unsupervised-pre-training-from)] [[code](https://github.com/wyf-accept/backtoreality)]
...
- Exploring Geometry-Aware Contrast and Clustering Harmonization for Self-Supervised 3D Object Detection [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Liang_Exploring_Geometry-Aware_Contrast_and_Clustering_Harmonization_for_Self-Supervised_3D_Object_ICCV_2021_paper.html)] [[paper with code](https://paperswithcode.com/paper/exploring-geometry-aware-contrast-and)]
...
- Pyramid R-CNN: Towards Better Performance and Adaptability for 3D Object Detection [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Mao_Pyramid_R-CNN_Towards_Better_Performance_and_Adaptability_for_3D_Object_ICCV_2021_paper.html)] [[arxiv](https://arxiv.org/abs/2109.02499)] [[paper with code](https://paperswithcode.com/paper/pyramid-r-cnn-towards-better-performance-and)] [[code](https://github.com/PointsCoder/Pyramid-RCNN)]

- Is Pseudo-Lidar Needed for Monocular 3D Object Detection? [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Park_Is_Pseudo-Lidar_Needed_for_Monocular_3D_Object_Detection_ICCV_2021_paper.html)] [[paper with code](https://paperswithcode.com/paper/is-pseudo-lidar-needed-for-monocular-3d)] [[code](https://github.com/tri-ml/dd3d)]

- Geometry-Based Distance Decomposition for Monocular 3D Object Detection [[paper](https://openaccess.thecvf.com/content/ICCV2021/html/Shi_Geometry-Based_Distance_Decomposition_for_Monocular_3D_Object_Detection_ICCV_2021_paper.html)] [[arxiv](https://arxiv.org/abs/2104.03775)] [[paper with code](https://paperswithcode.com/paper/geometry-based-distance-decomposition-for)] [[code](https://github.com/Rock-100/MonoDet)]
...
- RGB-D Salient Object Detection via 3D Convolutional Neural Networks [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/16191)] [[arxiv](https://arxiv.org/abs/2101.10241)] [[paper with code](https://paperswithcode.com/paper/rgb-d-salient-object-detection-via-3d)] [[code](https://github.com/PPOLYpubki/RD3D)]

- Voxel R-CNN: Towards High Performance Voxel-based 3D Object Detection [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/16207)] [[arxiv](https://arxiv.org/abs/2012.15712)] [[paper with code](https://paperswithcode.com/paper/voxel-r-cnn-towards-high-performance-voxel)] [[code](https://github.com/open-mmlab/OpenPCDet)]

- Semantic Consistency Networks for 3D Object Detection [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/16392)]
...
- Every View Counts: Cross-View Consistency in 3D Object Detection with Hybrid-Cylindrical-Spherical Voxelization [[paper](https://proceedings.neurips.cc/paper_files/paper/2020/hash/f2fc990265c712c49d51a18a32b39f0c-Abstract.html)] [[paper with code](https://paperswithcode.com/paper/every-view-counts-cross-view-consistency-in)]
...
- HVNet: Hybrid Voxel Network for LiDAR Based 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Ye_HVNet_Hybrid_Voxel_Network_for_LiDAR_Based_3D_Object_Detection_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/2003.00186)] [[paper with code](https://paperswithcode.com/paper/hvnet-hybrid-voxel-network-for-lidar-based-3d)]
...
- End-to-End Pseudo-LiDAR for Image-Based 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Qian_End-to-End_Pseudo-LiDAR_for_Image-Based_3D_Object_Detection_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/2004.03080)] [[paper with code](https://paperswithcode.com/paper/end-to-end-pseudo-lidar-for-image-based-3d)] [[code](https://github.com/mileyan/pseudo-LiDAR_e2e)]
...
- FroDO: From Detections to 3D Objects [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Runz_FroDO_From_Detections_to_3D_Objects_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/2005.05125)] [[paper with code](https://paperswithcode.com/paper/frodo-from-detections-to-3d-objects)]
...
- What You See is What You Get: Exploiting Visibility for 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Hu_What_You_See_is_What_You_Get_Exploiting_Visibility_for_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/1912.04986)] [[paper with code](https://paperswithcode.com/paper/what-you-see-is-what-you-get-exploiting)] [[code](https://github.com/peiyunh/wysiwyg)]

- SESS: Self-Ensembling Semi-Supervised 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Zhao_SESS_Self-Ensembling_Semi-Supervised_3D_Object_Detection_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/1912.11803)] [[paper with code](https://paperswithcode.com/paper/sess-self-ensembling-semi-supervised-3d)] [[code](https://github.com/Na-Z/sess)]
...
- Learning Depth-Guided Convolutions for Monocular 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Ding_Learning_Depth-Guided_Convolutions_for_Monocular_3D_Object_Detection_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/1912.04799)] [[paper with code](https://paperswithcode.com/paper/learning-depth-guided-convolutions-for)] [[code](https://github.com/dingmyu/D4LCN)]

- Disp R-CNN: Stereo 3D Object Detection via Shape Prior Guided Instance Disparity Estimation [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Sun_Disp_R-CNN_Stereo_3D_Object_Detection_via_Shape_Prior_Guided_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/2004.03572)] [[paper with code](https://paperswithcode.com/paper/disp-r-cnn-stereo-3d-object-detection-via)] [[code](https://github.com/zju3dv/disprcnn)]

- MLCVNet: Multi-Level Context VoteNet for 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Xie_MLCVNet_Multi-Level_Context_VoteNet_for_3D_Object_Detection_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/2004.05679)] [[paper with code](https://paperswithcode.com/paper/mlcvnet-multi-level-context-votenet-for-3d)] [[code](https://github.com/NUAAXQ/MLCVNet)]

- DSGN: Deep Stereo Geometry Network for 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Chen_DSGN_Deep_Stereo_Geometry_Network_for_3D_Object_Detection_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/2001.03398)] [[paper with code](https://paperswithcode.com/paper/dsgn-deep-stereo-geometry-network-for-3d)] [[code](https://github.com/chenyilun95/DSGN)]
...
- LiDAR-Based Online 3D Video Object Detection With Graph-Based Message Passing and Spatiotemporal Transformer Attention [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Yin_LiDAR-Based_Online_3D_Video_Object_Detection_With_Graph-Based_Message_Passing_CVPR_2020_paper.html)] [[arxiv](https://arxiv.org/abs/2004.01389)] [[paper with code](https://paperswithcode.com/paper/lidar-based-online-3d-video-object-detection)] [[code](https://github.com/yinjunbo/3DVID)]
...
- Monocular 3D Object Detection with Decoupled Structured Polygon Estimation and Height-Guided Depth Estimation [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/6618)] [[arxiv](https://arxiv.org/abs/2002.01619)] [[paper with code](https://paperswithcode.com/paper/monocular-3d-object-detection-with-decoupled)]
...
- Task-Aware Monocular Depth Estimation for 3D Object Detection [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/6908)] [[arxiv](https://arxiv.org/abs/1909.07701)] [[paper with code](https://paperswithcode.com/paper/task-aware-monocular-depth-estimation-for-3d)] [[code](https://github.com/WXinlong/ForeSeE)]

- ZoomNet: Part-Aware Adaptive Zooming Neural Network for 3D Object Detection [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/6945)] [[arxiv](https://arxiv.org/abs/2003.00529)] [[paper with code](https://paperswithcode.com/paper/zoomnet-part-aware-adaptive-zooming-neural)] [[code](https://github.com/detectRecog/ZoomNet)]
...
- Deep Fitting Degree Scoring Network for Monocular 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2019/html/Liu_Deep_Fitting_Degree_Scoring_Network_for_Monocular_3D_Object_Detection_CVPR_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1904.12681)] [[paper with code](https://paperswithcode.com/paper/deep-fitting-degree-scoring-network-for)]

- Multi-Task Multi-Sensor Fusion for 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2019/html/Liang_Multi-Task_Multi-Sensor_Fusion_for_3D_Object_Detection_CVPR_2019_paper.html)] [[arxiv](https://arxiv.org/abs/2012.12397)]

- Triangulation Learning Network: From Monocular to Stereo 3D Object Detection [[paper](https://openaccess.thecvf.com/content_CVPR_2019/html/Qin_Triangulation_Learning_Network_From_Monocular_to_Stereo_3D_Object_Detection_CVPR_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1906.01193)] [[paper with code](https://paperswithcode.com/paper/triangulation-learning-network-from-monocular-1)] [[code](https://github.com/Zengyi-Qin/TLNet)]
...
- Monocular 3D Object Detection Leveraging Accurate Proposals and Shape Reconstruction [[paper](https://openaccess.thecvf.com/content_CVPR_2019/html/Ku_Monocular_3D_Object_Detection_Leveraging_Accurate_Proposals_and_Shape_Reconstruction_CVPR_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1904.01690)] [[paper with code](https://paperswithcode.com/paper/monocular-3d-object-detection-leveraging)] [[code](https://github.com/ZhixinLai/3D-detection-with-monocular-RGB-image)]


## ICCV-2019


- Transferable Semi-Supervised 3D Object Detection From RGB-D Data [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Tang_Transferable_Semi-Supervised_3D_Object_Detection_From_RGB-D_Data_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1904.10300)] [[paper with code](https://paperswithcode.com/paper/transferable-semi-supervised-3d-object)]

- Disentangling Monocular 3D Object Detection [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Simonelli_Disentangling_Monocular_3D_Object_Detection_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1905.12365)] [[paper with code](https://paperswithcode.com/paper/disentangling-monocular-3d-object-detection)]
...
- Deep Hough Voting for 3D Object Detection in Point Clouds [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Qi_Deep_Hough_Voting_for_3D_Object_Detection_in_Point_Clouds_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1904.09664)] [[paper with code](https://paperswithcode.com/paper/deep-hough-voting-for-3d-object-detection-in)] [[code](https://github.com/facebookresearch/votenet)]

- M3D-RPN: Monocular 3D Region Proposal Network for Object Detection [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Brazil_M3D-RPN_Monocular_3D_Region_Proposal_Network_for_Object_Detection_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1907.06038)] [[paper with code](https://paperswithcode.com/paper/m3d-rpn-monocular-3d-region-proposal-network)] [[code](https://github.com/garrickbrazil/M3D-RPN)]

- Deep Optics for Monocular Depth Estimation and 3D Object Detection [[paper](https://openaccess.thecvf.com/content_ICCV_2019/html/Chang_Deep_Optics_for_Monocular_Depth_Estimation_and_3D_Object_Detection_ICCV_2019_paper.html)] [[arxiv](https://arxiv.org/abs/1904.08601)] [[paper with code](https://paperswithcode.com/paper/deep-optics-for-monocular-depth-estimation)]


## AAAI-2019


- 3D Object Detection Using Scale Invariant and Feature Reweighting Networks [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/4963)] [[arxiv](https://arxiv.org/abs/1901.02237)] [[paper with code](https://paperswithcode.com/paper/3d-object-detection-using-scale-invariant-and)]
...
- 3D Object Detection With Latent Support Surfaces [[paper](https://openaccess.thecvf.com/content_cvpr_2018/html/Ren_3D_Object_Detection_CVPR_2018_paper.html)] [[paper with code](https://paperswithcode.com/paper/3d-object-detection-with-latent-support)]

- Multi-Level Fusion Based 3D Object Detection From Monocular Images [[paper](https://openaccess.thecvf.com/content_cvpr_2018/html/Xu_Multi-Level_Fusion_Based_CVPR_2018_paper.html)] [[paper with code](https://paperswithcode.com/paper/multi-level-fusion-based-3d-object-detection)]

- VoxelNet: End-to-End Learning for Point Cloud Based 3D Object Detection [[paper](https://openaccess.thecvf.com/content_cvpr_2018/html/Zhou_VoxelNet_End-to-End_Learning_CVPR_2018_paper.html)] [[arxiv](https://arxiv.org/abs/1711.06396)] [[paper with code](https://paperswithcode.com/paper/voxelnet-end-to-end-learning-for-point-cloud)] [[code](https://github.com/qianguih/voxelnet)]
...
- Deep Continuous Fusion for Multi-Sensor 3D Object Detection [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Ming_Liang_Deep_Continuous_Fusion_ECCV_2018_paper.php)] [[arxiv](https://arxiv.org/abs/2012.10992)] [[paper with code](https://paperswithcode.com/paper/deep-continuous-fusion-for-multi-sensor-3d-1)]

- Eliminating the Blind Spot: Adapting 3D Object Detection and Monocular Depth Estimation to 360° Panoramic Imagery [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Gregoire_Payen_de_La_Garanderie_Eliminating_the_Dreaded_ECCV_2018_paper.php)] [[arxiv](https://arxiv.org/abs/1808.06253)] [[paper with code](https://paperswithcode.com/paper/eliminating-the-blind-spot-adapting-3d-object-1)] [[code](https://github.com/gdlg/panoramic-depth-estimation)]

- Implicit 3D Orientation Learning for 6D Object Detection from RGB Images [[paper](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Martin_Sundermeyer_Implicit_3D_Orientation_ECCV_2018_paper.php)] [[arxiv](https://arxiv.org/abs/1902.01275)] [[paper with code](https://paperswithcode.com/paper/implicit-3d-orientation-learning-for-6d)] [[code](https://github.com/DLR-RM/AugmentedAutoencoder)]